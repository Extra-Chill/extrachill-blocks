 ...
 * REST endpoint: /wp-json/extrachill-blocks/v1/vote-count/{post_id}/{instance_id}
 * AJAX action: extrachill_blocks_image_vote
 * Newsletter integration: extrachill_multisite_subscribe() bridge function (line 129)
 */
...
function extrachill_blocks_handle_image_vote() {
    ...
    foreach ($blocks as $block) {
        if ($block['blockName'] === 'extrachill-blocks/image-voting') {
            // Use uniqueBlockId from block attributes (matches frontend render)
 ...
 * Priority 20 runs after WordPress auto-enqueues viewScript from block.json
 * Handle generated by generate_block_asset_handle(): block-name + '-view-script'
 */
